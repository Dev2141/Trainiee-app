...
/* ═══════════════════════════════════════════════════════════
   Professional SVG Icon Library — replaces all emojis.
   All icons are 24×24 viewBox, stroke-based for consistency.
   ═══════════════════════════════════════════════════════════ */
...
export const BarChart = (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <rect x="12" y="1" width="4" height="22" rx="1" /><rect x="4" y="7" width="4" height="16" rx="1" /><rect x="20" y="11" width="0" height="0" rx="0" /><path d="M20 11v12h0a1 1 0 01 0 0" /><rect x="20" y="11" width="0" height="12" rx="1" />
    </svg>
);
...
export const Battery = (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <rect x="3" y="8" width="12" height="8" rx="1" fill="currentColor" opacity="0.3" />
    </svg>
);

export const Signal = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
        <rect x="2" y="16" width="4" height="6" rx="1" /><rect x="8" y="12" width="4" height="10" rx="1" /><rect x="14" y="7" width="4" height="15" rx="1" /><rect x="20" y="2" width="4" height="20" rx="1" opacity="0.3" />
    </svg>
);
...
export const HighQuality = (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <circle cx="12" cy="12" r="10" /><path d="M8 8v8M8 12h4M16 8v8" />
    </svg>
);
